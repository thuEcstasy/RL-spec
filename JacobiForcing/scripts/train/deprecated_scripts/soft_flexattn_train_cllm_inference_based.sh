...
output_path="/checkpoint/lhu/train_ckpts/cllm/one-pass-efficient-train-cllm-openthinker2-7B-ntok64_cllm_soft_loss_length_capped_16k_flexattn_siqi_data_1_ar_10"
n_token_seq_size=64
qlora=False
