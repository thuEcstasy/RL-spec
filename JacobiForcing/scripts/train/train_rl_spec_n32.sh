...
model_path="${prefix}/huggingface/Qwen2.5-Coder-3B-Instruct"
#trajectory_file="/checkpoint/lhu/data/CLLM2_openthought/merged/merged_data_v2_8_27_opencodeinstruct.jsonl"
prompt_file="${prefix}/datasets/OpenCodeInstruct/data/train-00011-of-00050.jsonl"
output_path="${prefix}/RL-spec/JacobiForcing/outputs/rl_spec_ref1_n32w16"
n_token_seq_size=32
qlora=False
