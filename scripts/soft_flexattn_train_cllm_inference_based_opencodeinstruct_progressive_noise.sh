...
trajectory_file="/checkpoint/lhu/data/CLLM2_openthought/merged/40k_samples_merged_data_v2_8_27_opencodeinstruct_progressive_noise_cyclic_cap_idx_0p5.jsonl"
output_path="/checkpoint/lhu/train_ckpts/cllm/logitsaligned-8-28-cllm-qwen2p5-coder-7B-ntok16_ce_soft_loss_flexattn_oci_data_v1_40k_samples_ar_1_only_cyclic_progressive_noise_ratio_0p5_lr5e-6"
n_token_seq_size=16
qlora=False
